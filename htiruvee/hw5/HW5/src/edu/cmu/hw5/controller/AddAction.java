...
import edu.cmu.hw5.formbean.CommentForm;
...
public class AddAction extends Action{
	...
	public String perform(HttpServletRequest request) {
		...
		System.out.println("In add action"+userName);
		...
		if(postID!=null) {
			...
			comment.setUserName(((User) request.getSession().getAttribute("user")).getUserName());
